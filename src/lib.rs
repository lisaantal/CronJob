...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CronJob processing");
    
    let mut processor = CronJobProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CronJobProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CronJobProcessor::new(false);
